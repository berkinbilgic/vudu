...
% $Id: mrir_array_whitening_operator.m,v 1.2 2008/04/23 02:31:07 jonnyreb Exp $
%**************************************************************************%
  ...
  %************************************************************************%
  %%% $Source: /space/padkeemao/1/users/jonnyreb/cvsjrp/PROJECTS/IMAGE_RECON/mrir_toolbox/mrir_array_whitening_operator.m,v $
  %%% Local Variables:
  %%% mode: Matlab
  %%% fill-column: 76
  %%% comment-column: 0
